...
import com.starrocks.connector.flink.plugins.TableMetricsManager;
...
public class StarRocksWriter<InputT>
    ...
    public StarRocksWriter(
        ...
        RedisPlugin.init(sinkOptions);
        this.redisPlugin=RedisPlugin.getInstance();
        this.streamLoadListener = new StarRocksStreamLoadListener(redisPlugin);
        ...
        try {
            ...
            try {
                sinkManager.close();
                if(this.redisPlugin!=null) this.redisPlugin.close();
            } catch (Exception ie) {
    ...
    public void write(InputT element, Context context) throws IOException, InterruptedException {
        ...
        this.redisPlugin.receivedCountIncrement(TableMetricsManager.genTableId(rowData.getDatabase(),rowData.getTable()));
