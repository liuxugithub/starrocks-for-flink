...
public class StarRocksSinkOptions implements Serializable {
    ...
    public static final ConfigOption<String> REDIS_URLS = ConfigOptions.key("redis-url")
            .stringType().noDefaultValue().withDescription("StarRocks redis hosts.");

    public static final ConfigOption<String> REDIS_pwd = ConfigOptions.key("redis-pwd")
            .stringType().noDefaultValue().withDescription("StarRocks redis hosts.");
    ...
    public String getRedisHosts(){
        return tableOptions.get(REDIS_URLS);
    }
    public String getRedisPassWord(){
        return tableOptions.get(REDIS_pwd);
    }
